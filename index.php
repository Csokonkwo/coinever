        ...
        <div class="abou">
            <div class="container">
                <div class="box">
                    <h2>About Us</h2>
                    <p>
                        <?php echo $companyRealName ?> is a foremost non-bank finance company offering first class investment plans, financial advisory, corporate finance and Wealth management services to private clients, institutional investors and the clients of financial advisers. <br> <br>
                        Our firm is focused on providing unbaised advisory and investment services to entities and individuals involved in investing in Forex, gold , bond, Stock market and private equities
                    </p>
                </div>
                <div class="box">
                    <div class="content">
